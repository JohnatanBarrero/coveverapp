...
class FormLastNameDocumentWidget extends StatelessWidget {
  const FormLastNameDocumentWidget({
    super.key,
  ...
  Widget build(BuildContext context) {
    return FormTextWidget(
        validator: (value) {
        if ((value ?? '').isEmpty) {
          return  S.current.fieldLastNameInvalid;
        }
        return null;
      },
      focusNode: focusNode,
